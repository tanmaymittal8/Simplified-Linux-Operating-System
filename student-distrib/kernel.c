...
unsigned int * file_system_start;
...
void entry(unsigned long magic, unsigned long addr) {
    ...
    initialize_idt();
    init_file_systems(file_system_start);
    /* Init the PIC */
    i8259_init();
    keyboard_init();
    rtc_init();
    ...
    //set our variable to show we started the first shell and then execute it
    terminalInstantiated[0] = 1;
